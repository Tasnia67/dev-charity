  ...
  THEMEMASCOT.header = {
    ...
    TM_scrollToFixed: function () {
      ...
      $(".scrolltofixed").scrollToFixed({
        ...
        limit: function () {
          var limit =
            $(".footer").offset().top - $(this).outerHeight(true) - 10;
          return limit;
        },
      });
    },
    ...
    TM_flexslider: function () {
      ...
      if ($each_flex_slider.length > 0) {
        $each_flex_slider.each(function () {
          ...
          var data_direction =
            $flex_slider.data("direction") === undefined
              ? "horizontal"
              : $flex_slider.data("direction");
          var data_controlNav =
            $flex_slider.data("controlnav") === undefined
              ? false
              : $flex_slider.data("controlnav");
          var data_directionnav =
            $flex_slider.data("directionnav") === undefined
              ? false
